/*
 * @Author: your name
 * @Date: 2021-08-20 14:44:13
 * @LastEditTime: 2021-08-20 16:59:49
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /CLI/vision-code/lib/apicode/generateInterface/index.js
 */
const { resolve, basename } = require('path');
const request = require('../../utils/request');
const { removeEmpty, pathCamelCase } = require('../../utils');
